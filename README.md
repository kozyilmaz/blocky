...
var store_on_blockchain = eth.contract([{
 ...
 storeContract.abi > store.abi [{ constant: false, inputs: [{ name: "x", type: "uint256" }], name: "set", outputs: [], payable: false, type: "function" }, { constant: true, inputs: [], name: "get", outputs: [{ name: "", type: "uint256" }], payable: false, type: "function" }] > store.address "0x366e0869aea00583c5a5ff62309214707d82e60c" var storeOnBlockchain = eth.contract(%ABI_FROM_ABOVE%).at(%ADDRESS_FROM_ABOVE%); var storeOnBlockchain = eth.contract([{ constant: false, inputs: [{ name: "x", type: "uint256" }], name: "set", outputs: [], payable: false, type: "function" }, { constant: true, inputs: [], name: "get", outputs: [{ name: "", type: "uint256" }], payable: false, type: "function" }]).at("0x366e0869aea00583c5a5ff62309214707d82e60c");
```
